...
@dag(
    ...
    catchup=False # Define se vai executar todas as execuções que, por algum motivo, não conseguiu concluir
)
def postgres_to_snowflake_etl():
    ...
    for table_name in table_names:
        ...
        def get_max_primary_key(table_name: str):
            with SnowflakeHook(Snowflake_conn_id='snowflake').get_conn() as connection:
